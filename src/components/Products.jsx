...
import bmsUnitImg from '../assets/products/bms_unit.png';
  ...
  const products = [
    {
      ...
      title: 'On-Board Chargers',
      description: 'High-efficiency automotive On-Board Chargers (3.3kW and 1.2kW) designed for reliable electric vehicle power conversion.',
    ...
    },
    {
      ...
      icon: <Zap size={32} />,
      title: 'EV Chargers',
      description: 'Robust and scalable electric vehicle charging solutions with advanced communication protocols for modern infrastructure.',
      image: evChargerImg,
    ...
    },
    {
      ...
      description: 'High-performance Motor Controllers for electric vehicles, featuring precise torque control, regenerative braking, and robust thermal management.',
    ...
    },
    {
      ...
      description: 'Monitors, protects, and optimizes EV battery packs. Continuously measures cell voltage, current, and temperature, estimates SOC/SOH, and ensures safe operation via over-voltage, over-current, and thermal protection.',
      image: bmsUnitImg,
      tags: ['BMS', 'EV', 'Safety Control']
    },
    {
      id: 4,
  ...
  return (
    <section id="products" className="section products">
      <div className="container">
        <h2 className="section-title">Products & Solutions IP <span className="text-gradient"></span></h2>
